...
path = ['student_save_merge/best_model_merge_2/', 'student_save_merge/mid_model_merge_2/', 'student_save_merge/mid_model_merge_2_epoch5/']

# last2_best: 0.8485495078813116
# last2_mid_last: 0.7888840337344966
# last2_mid_epoch_5: 0.7971217556843908
...
def fit():
    ...
    def fit_step(inputs, target):
        ...
        for var in student_model.trainable_variables:
            if 'attention' in var.name:
                ...
                stu_var_num = int(stu_var_num) + 10
                # 这里取最后teacher模型的最后两层
    ...
    for num in range(10):
        ...
        student_model.save('student_save_merge/mid_model_merge_2/')

        if num == 4:
            student_model.save('student_save_merge/mid_model_merge_2_epoch5/')


        f1_stu = valid_process(path='student_save_merge/mid_model_merge_2/')
        ...
        if f1_stu > f1_value_start_stu:
            ...
            teacher_model.save('student_save_merge/best_model_merge_2/')
