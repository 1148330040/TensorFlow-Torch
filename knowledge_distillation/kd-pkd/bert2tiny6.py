...
tokenizer = BertTokenizer.from_pretrained("uer/chinese_roberta_L-6_H-768")
...
def valid_process():
    model = tf.saved_model.load('student_save/mid_model_6/')
...
path = ['student_save/best_model_6/', 'student_save/mid_model_6/', 'student_save/mid_model_6_epoch5/']
# best: 0.8516354635559804
# mid_last: 0.844017675267576
# mid_epoch_5: 0.8389883459903864
for pth in path:
    print("pth: ", pth)
...
def fit():
    ...
    for num in range(20):
        ...
        student_model.save('student_save/mid_model_6/')
        if num == 4:
            student_model.save('student_save/mid_model_6_epoch5/')
        ...
        if f1 > f1_value:
            f1_value = f1
            student_model.save('student_save/best_model_6/')
