...
tokenizer = BertTokenizer.from_pretrained("uer/chinese_roberta_L-4_H-768")
...
def valid_process():
    model = tf.saved_model.load('student_save/mid_model_4/')
...
path = ['student_save/best_model_4/', 'student_save/mid_model_4/', 'student_save/mid_model_4_epoch5/']
# best: 0.8477688639537649
# mid_last: 0.8383624579453254
# mid_epoch_5: 0.8330685952273776
...
def fit():
    ...
    for num in range(10):
        ...
        student_model.save('student_save/mid_model_4/')
        if num == 4:
            student_model.save('student_save/mid_model_4_epoch5/')
        ...
        if f1 > f1_value:
            f1_value = f1
            student_model.save('student_save/best_model_4/')
