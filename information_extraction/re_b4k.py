...
# 加载数据集
path = 'dataset/duie/duie_schema/duie_schema.json'
train_data = load_data('dataset/duie/duie_train.json/duie_train.json')
valid_data = load_data('dataset/duie/duie_dev.json/duie_dev.json')
predicate2id, id2predicate = {}, {}

with open('dataset/duie/duie_schema/duie_schema.json') as f:
    for l in f:
        l = json.loads(l)
...
optimizer = Adam(learning_rate=1e-5, beta_1=0.9, beta_2=0.95)
...
def evaluate(data):
    ...
    for d in data:
        ...
        T = set([SPO(spo) for spo in spo_t])
