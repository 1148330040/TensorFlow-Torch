...
# 读取数据
train_data = load_data('../dataset/duee/duee_train.json/duee_train.json')
valid_data = load_data('../dataset/duee/duee_dev.json/duee_dev.json')

# 读取schema
with open('../dataset/duee/duee_event_schema.json') as f:
...
class Evaluator(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if f1 >= self.best_val_f1:
            self.best_val_f1 = f1
            model.save_weights('best_model_b4k.weights')
        print(
...
#     evaluator = Evaluator()
#     model.load_weights('best_model_b4k.weights')
#     model.fit_generator(
...
# else:
model.load_weights('best_model_b4k.weights')
predict_to_file('../dataset/duee/duee_test2.json/duee_test2.json', 'ee_b4k.json')